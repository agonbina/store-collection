...
require.register("agonbina~store-model@v0.1.0", function (exports, module) {


module.exports = require("agonbina~store-model@v0.1.0/lib/model.js");


});

require.register("agonbina~store-model@v0.1.0/lib/model.js", function (exports, module) {
var Store = require("bredele~datastore@1.0.6");
var storeModel = require("agonbina~store-model@v0.1.0/lib/plugin.js");
...
Model.prototype = {
    ...
    create: function (data) {
        ...
        model.use(storeModel);

        // Adds a computed 'href' attribute to the model
        var options = this.options;
        if (options.has('url') && model.has('id')) {
            model.compute('href', function () {
...
require.register("agonbina~store-model@v0.1.0/lib/plugin.js", function (exports, module) {
...
require.register("store-collection", function (exports, module) {

module.exports = require("store-collection/lib/collection.js");
});

require.register("store-collection/lib/collection.js", function (exports, module) {
...
var Store = require("bredele~datastore@1.0.6");
var Model = require("agonbina~store-model@v0.1.0");
var assert = require("component~assert@0.4.0");
var collectionPlugin = require("store-collection/lib/plugin.js");
...
require.register("store-collection/lib/plugin.js", function (exports, module) {
